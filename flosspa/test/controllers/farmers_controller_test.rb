...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post farmers_url, params: { farmer: { email: @farmer.email, image: @farmer.image, name: @farmer.name, phone_number: @farmer.phone_number } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { email: @farmer.email, image: @farmer.image, name: @farmer.name, phone_number: @farmer.phone_number } }
